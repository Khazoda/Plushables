...
public class AAABasketBlockEntity extends BlockEntity {
  private final DefaultedList<ItemStack> plushieStack = DefaultedList.ofSize(4, ItemStack.EMPTY);
  private int topIndex;
  private boolean isEmpty = true;

  public AAABasketBlockEntity(BlockPos pos, BlockState state) {
...
//    return false;
  ...
  public static void tick(World world, BlockPos pos, BlockState state, AAABasketBlockEntity be) {

...
public class TrufflesBlock extends SimplePlushable {
	...
	static public VoxelShape getShape() {
		...
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.390625, 0.140625, 0.078125, 0.609375, 0.234375, 0.125));
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.625, 0.46875, 0.125, 0.75, 0.59375, 0.125));
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.4375, 0.25, 0.875, 0.5625, 0.375, 0.90625));

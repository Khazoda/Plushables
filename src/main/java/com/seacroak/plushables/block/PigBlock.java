...
public class PigBlock extends SimplePlushable {
	...
	static public VoxelShape getShape() {
		...
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.125, 0, 0.125, 0.3125, 0.1875, 0.5));
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.59375, 0, 0.1875, 0.96875, 0.1875, 0.375));
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.25, 0.003125, 0.21875, 0.75, 0.3156249999999998, 0.875));
		...
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.34375, 0, 0.03125, 0.65625, 0.3125, 0.21875));
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.421875, 0.0625, -0.03125, 0.578125, 0.15625, 0.03125));
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.375, 0.3125, 0.0625, 0.5, 0.328125, 0.1875));
		shape = VoxelShapes.union(shape, VoxelShapes.cuboid(0.375, 0.328125, 0.125, 0.5, 0.515625, 0.125));
		return shape;
	}

...
public class RupertBlock extends BlockWithEntity {
	static Random rand;
  ...
  public void appendTooltip(ItemStack stack, @Nullable BlockView world,
    ...
    tooltip.add(Text.translatable("An animatronic plush, safely boxed").formatted(Formatting.ITALIC).formatted(Formatting.DARK_GRAY));
